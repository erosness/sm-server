...
(define-handler /v1/dummy-tabs (lambda () `((tabs . #( ((title . "Tab 1") (uri . "/dummy/tab1"))
                                               ((title . "Tab 2") (uri . "/trick/tab2")))))))

(define-handler /v1/dummy/tab1
  (lambda () (make-search-result 10 0 1
                            `( ((title . "My Folder")
                                (uri . "/dummy/tab1/folder1"))))))

(define-handler /v1/dummy/tab1/folder1
  (lambda () (make-search-result 10 0 1
                            `( ((title . "Playable Track")
                                (turi . "tr://localhost/this-almost-works.mp3"))))))

(define-handler /v1/trick/tab2
